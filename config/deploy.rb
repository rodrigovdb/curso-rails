...
# Esta task determina como sera o ambiente ao executar tarefas do setup
task :setup_environment do
end

# Esta task determina como sera o ambiente ao executar demais tarefas
task :environment do
...
task setup: :setup_environment do
  invoke 'create_deploy_dirs'.to_sym
  invoke 'install_dependencies'.to_sym
  invoke 'install_rvm'.to_sym
end
...
# Cria os diretorios requiridos para fazer o deploy
...
# Instala o RVM de acordo com as recomendacoes do rvm.io
